...
#set.seed(123)
trt_nobaseline <- subset(trt, subset = asymmetry != "symm" & synchrony != "med")
run_nobaseline <- subset(run, subset = asymmetry != "symm" & synchrony != "med")
...
ggplot(trt_nobaseline, 
  ...
  scale_x_discrete(breaks = c("survival", "size", "emergence_time", "biomass"),
                   labels = c("survival", "mean per capita size", "time to emergence", "biomass export")) +
