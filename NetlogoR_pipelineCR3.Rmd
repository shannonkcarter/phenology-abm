...
## making the effect size/mean differences plot 
```{r}
...
## first, the raw data
ggplot(data = run, aes(x = synchrony, y = abs_value, 
                fill = asymmetry, color = asymmetry, group = asymmetry, shape = asymmetry)) + 
  mytheme +
  #stat_smooth() +
  ...
  #geom_point(data = trt, aes(x = synchrony, y = abs_value_exp,
  #                           fill = asymmetry, color = asymmetry, group = asymmetry), size = 3,
  #           position = position_dodge(width = 0.5)) 
  #geom_errorbar(data = trt, aes(x = synchrony, color = asymmetry, group = asymmetry, 
  #                              ymin = (abs_value_exp - se_exp.x), ymax = abs_value_exp + se_exp.x), width = 0)

```

# Working with dabestr 
