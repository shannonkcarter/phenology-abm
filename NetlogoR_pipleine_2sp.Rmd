...
## write out response variable names for facet wrap
baseline_means <- subset(trt, subset = (sync_fish == "low"))
...
meandiffs_trt <- subset(meandiffs_trt, subset = (sync_fish != "low"))
...
## first, the raw data
rawdata <- ggplot(data = run, aes(x = sync_fish, y = mean, 
...
mean_diffs <- ggplot(meandiffs_trt, aes(x = sync_fish, y = umd, 
