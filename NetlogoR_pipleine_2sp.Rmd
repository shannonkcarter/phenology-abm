...
fig4
#tiff("fig4.tiff", height = 7500, width = 5200, units = "px", res = 800, compression = "lzw")
#plot(fig4)
#dev.off()
```
...
fig6 <- ggplot(subset(ind_fewsync, subset = (meta == 1)),
       aes(x = hatch_date, y = growth_rate, color = species)) + mytheme +
  ...
  scale_color_manual(values = c("#5DBCD2", "#FFB986")) + 
