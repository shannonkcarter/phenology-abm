...
d <- ind %>% 
  ...
  mutate(hatch_date_relative = hatch_date - min(hatch_date))

## Fitness = mass model
m_size <- aov(data = d, size_relative ~ hatch_date_relative + sync_fish + mean_fish +
                   hatch_date_relative*sync_fish +
                   hatch_date_relative*mean_fish +
                   sync_fish*mean_fish +
                   hatch_date_relative*sync_fish*mean_fish)
print(summary(m_size))
coef(m_size)

## Fitness = survival model
m_surv <- aov(data = d, meta ~ hatch_date_relative + sync_fish + mean_fish +
                   hatch_date_relative*sync_fish +
                   hatch_date_relative*mean_fish +
                   sync_fish*mean_fish +
                   hatch_date_relative*sync_fish*mean_fish)
