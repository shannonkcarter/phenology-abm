...
data <- read.table("bs_CRnometa_20.csv",
                   header = T,  
...
rawdata <- ggplot(data = run, aes(x = synchrony, y = abs_value, 
  ...
  geom_point(size = 1.5, alpha = 1/2,
             position = position_dodge(width = 0.5)) +
  #facet_grid(var~., scales = "free", switch = 'y',labeller = variable_labeller) +
  facet_wrap(~var, ncol = 1, scales = "free_y", labeller = variable_labeller) +
...
mean_diffs <- ggplot(meandiffs_trt, aes(x = synchrony, y = umd, 
  ...
  theme(legend.position = "none",
    axis.title.y = element_text(margin = margin(t = 0, r = 30, b = 0, l = 0))) +
  labs(x = "phenological synchrony", y = "proportional difference from appropriate asymmetry at high synchrony", y = NULL) 
