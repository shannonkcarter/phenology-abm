...
variable_names_rel <- list(
  'surv' = "survival (%change from high sync)",
  'biom' = "biomass export (%change from high sync)",
  'mass' = "per capita mass (%change from high sync)",
  'grow' = "per capita growth (%change from high sync)", 
  'emer' = "advancement date (%change from high sync)"
)
